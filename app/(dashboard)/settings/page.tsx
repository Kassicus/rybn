        ...
        <div className="space-y-4">
          ...
          <div className="flex items-start justify-between p-4 rounded-lg border border-light-border hover:bg-light-background transition-colors">
            ...
            <label className="relative inline-flex items-center cursor-pointer">
              ...
              />
              <div className="w-11 h-6 bg-muted peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-primary-light rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-light-background after:border-control-line after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-primary"></div>
            </label>
          </div>
